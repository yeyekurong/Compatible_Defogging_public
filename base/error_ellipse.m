function error_ellipse(data,chisquare_val)
% clear all;
% close all;
% 
...
smallest = sqrt(smallest_eigenval)
ratio = smallest_eigenval/largest_eigenval
%covariance(2)/max(covariance(4),covariance(1))
